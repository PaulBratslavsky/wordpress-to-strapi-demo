...
export interface ApiDepartmentDepartment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Migrated from WordPress (taxonomy: department)';
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Migrated from WordPress (taxonomy: industry)';
...
export interface ApiPortfolioItemPortfolioItem
  ...
  info: {
    description: 'Migrated from WordPress (postType: portfolio_item)';
    displayName: 'Portfolio Post';
  ...
  attributes: {
    ...
    industry: Schema.Attribute.Relation<'manyToMany', 'api::industry.industry'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    publishedDate: Schema.Attribute.DateTime;
    resultsHeadline: Schema.Attribute.String;
    resultsMetric: Schema.Attribute.String;
    resultsSummary: Schema.Attribute.String;
    servicesProvided: Schema.Attribute.Relation<
      'manyToMany',
      'api::service.service'
    >;
    slug: Schema.Attribute.UID<'title'>;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featuredImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    keyTakeaway: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Migrated from WordPress (postType: services)';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    >;
    slug: Schema.Attribute.UID<'title'>;
    startingPrice: Schema.Attribute.Integer;
    tagline: Schema.Attribute.String;
    timelineWeeks: Schema.Attribute.Integer;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Migrated from WordPress (postType: team)';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Migrated from WordPress (postType: testimonials)';
